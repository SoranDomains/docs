...
You own a namespace; now give people names in it. Issuance happens in the console's **Issuance** tab (or via the same flows from your own tooling — the contracts are permissionless).
...
<Steps>
  <Step title="Choose the ownership policy">
    ...
    - **Permanent** — issued names can never be reclaimed or expired by anyone, and the contract enforces it.
  </Step>
