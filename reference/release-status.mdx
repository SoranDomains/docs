...
The [machine-readable deployment record](/reference/deployments/testnet.json) includes exact Wasm hashes, deployment ledgers, transaction hashes, governance and fee configuration. Its contents are public configuration, with no signing secrets.
