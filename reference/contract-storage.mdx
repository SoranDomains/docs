...
This Node example uses `@stellar/stellar-sdk@17.0.1` and `@sorandomains/lookup@0.10.0`. It reads a Registry namespace record and the Resolver's raw address, payment text and generation marker. It only reads state. Use an active name from the [live examples](/live-examples), or one you have issued.
