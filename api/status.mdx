...
Poll this endpoint to build claim-tracking UIs. Its `ledger` is the observed head, not proof every displayed claim was processed through that ledger. Check indexer status and coverage; confirm claim and fee state on chain before signing.
