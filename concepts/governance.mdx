...
The current testnet rollout replaces all six deployment addresses to introduce the Registry's namespace-and-role-bound deployment salts. It does not upgrade either earlier immutable Registry in place. All integrations must use the matching current Registry, Lookup and optional Primary together. See [release status](/reference/release-status) and [namespace address prediction](/concepts/names-and-namespaces#namespace-contract-addresses).
