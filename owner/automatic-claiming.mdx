...
The examples target Owner 0.7.0 and Holder 0.6.0; their publication and hosted console
...
These examples target **Owner 0.7.0 and Holder 0.6.0**. Check their publication
...
Holder 0.6.0 checks the Registry’s Registrar attestation and deployed code after
